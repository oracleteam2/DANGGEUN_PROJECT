...
DROP TABLE NOTICEBOARD_LOG_INFO;
DROP TABLE DANGGEUN_PAY;
DROP TABLE ADMIN;
DROP TABLE ADMIN_LOG_INFO;
...
DROP TABLE COMM_CMT;
DROP TABLE COMM_BOARD_LIKE;
DROP TABLE COMM_BOARD;
DROP TABLE COMM_CTGR;
DROP TABLE MANNER_POINTS;
DROP TABLE MEMBER;
...
DROP SEQUENCE SEQ_CHATCONTENT_ROOM1_ID;
DROP SEQUENCE SEQ_CHATROOM_ID;
DROP SEQUENCE SEQ_COMM_CMT_LIKE;
DROP SEQUENCE SEQ_COMM_LIKE;
DROP SEQUENCE SEQ_COMM_NUM;
DROP SEQUENCE SEQ_IMAGE;
DROP SEQUENCE SEQ_MANNER_POINTS;
DROP SEQUENCE SEQ_MEMBER_ID;
DROP SEQUENCE SEQ_NOTICE_BOARD_ID;
DROP SEQUENCE SEQ_PAY;
DROP SEQUENCE SEQ_RCMT_LIKE;
DROP SEQUENCE SEQ_RCMT_NUM;
...
DROP PROCEDURE ADD_REPLY;
DROP PROCEDURE CHECK_COMMENTS;
DROP PROCEDURE DELCHAT;
DROP PROCEDURE DELCONTENT;
DROP PROCEDURE SEEK_CHAT_CONTENT;
DROP PROCEDURE SEEK_LIST;
DROP PROCEDURE UP_ADMINLOGINFO;
DROP PROCEDURE UP_CHARGE_DANGGEUN_PAY;
DROP PROCEDURE UP_CHECKCMT;
DROP PROCEDURE UP_CHECKREPLY;
DROP PROCEDURE UP_DELADMIN;
DROP PROCEDURE UP_DELBOARDLIKE;
DROP PROCEDURE UP_DELCMT;
DROP PROCEDURE UP_DELCOMMCTGR;
DROP PROCEDURE UP_DELTRADEBOARD;
DROP PROCEDURE UP_INSADMIN;
DROP PROCEDURE UP_INSBLOCK;
DROP PROCEDURE UP_INSBOARDLIKE;
DROP PROCEDURE UP_INSCOMMCTGR;
DROP PROCEDURE UP_INSERT_DANGGEUN_PAY;
DROP PROCEDURE UP_INSERT_MANNER_POINTS;
DROP PROCEDURE UP_INSERT_MEMBER;
DROP PROCEDURE UP_INSERT_PAY;
DROP PROCEDURE UP_INSERT_T_BOARD_LIKE;
DROP PROCEDURE UP_INSNOTICEBOARD;
DROP PROCEDURE UP_INSREPORT;
DROP PROCEDURE UP_MEMBERLOGINFO;
DROP PROCEDURE UP_NOTICEBOARDLOGINFO;
DROP PROCEDURE UP_SELADMINALL;
DROP PROCEDURE UP_SELBLOCK;
DROP PROCEDURE UP_SELCOMMBOARD;
DROP PROCEDURE UP_SELECT_MPAGE;
DROP PROCEDURE UP_SELNOTICEBOARDALL;
DROP PROCEDURE UP_SELNOTICEBOARDINFO;
DROP PROCEDURE UP_SELTRADEBOARD;
DROP PROCEDURE UP_ADMIN;
DROP PROCEDURE UP_UPDATE_MEMBER;
DROP PROCEDURE UP_UPDCMT;
DROP PROCEDURE UP_UPDCOMMCTGR;
DROP PROCEDURE UP_UPDITEMIMAGE;
DROP PROCEDURE UP_UPDNOTICEBOARD;
DROP PROCEDURE UP_UPDTRADEBOARD;
DROP PROCEDURE UP_DELCOMMBOARD;
DROP PROCEDURE UP_DELITEMIMAGE;
DROP PROCEDURE UP_DELNOTICEBOARD;
DROP PROCEDURE UP_INSCMTREPLYLIKE;
DROP PROCEDURE UP_INSDELBOARDLIKE;
DROP PROCEDURE UP_SELADMININFO;
DROP PROCEDURE UP_UPDADMIN;

-- 트리거
DROP TRIGGER DELETE_RELATED_TRADE_BOARD;
DROP TRIGGER UT_ADMINLOGINFO;
DROP TRIGGER UT_MEMBERLOGINFO;
DROP TRIGGER UP_NOTICEBOARDLOGINFO;
DROP TRIGGER UP_UPDATE_MEM_MANNER;
DROP TRIGGER UT_DEL_RELATED_TRADE_BOARD; -- 새로 추가될 트리거
DROP TRIGGER UT_DEL_RELATED_COMM_BOARD;  -- 새로 추가될 트리거
